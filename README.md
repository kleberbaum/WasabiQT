...
event glue; the actual VM and widget classes come from the leaked
...
the leaked `Src/` tree, and builds against it.

## How to build

```bash
# 1. Get the leaked Winamp source release. It's been mirrored on
