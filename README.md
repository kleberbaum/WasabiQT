...
- The Wasabi widget *behaviour* is matched against the leaked source
...
scripts/              — fetch-wasabi.sh (downloads leaked source
...
`WASABI_SRC_DIR` pointing at an extracted leaked-source tree, the
...
## What we use from the leaked source
...
Total: ~2000 LOC of leaked source — pure containers, GUID compare,
