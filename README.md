...
the leaked Winamp source. Thousands of shipped skins exercise quirks of
...
## Why not just "Qt-ify" the leaked source in place?

The leaked source is a build-system maze — Visual Studio, Xcode,
