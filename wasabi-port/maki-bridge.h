...
//
// maki-bridge.h, clean C++ surface for the leaked VCPU class.
//
...
// Must be valid UTF-16 with lifetime past the script's lifetime, // SkinRuntime keeps a backing QString it owns.
...
// the caller needing to include the leaked <api/script/scriptobj.h>.
//
